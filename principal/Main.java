/**
 * Clase principal del programa que realiza pruebas de la biblioteca "calculadora".
 * @author Eduardo
 * @version 0.1
 * @since 1.0
 */
...
public class Main {
	...
	/**
	 * El método principal se encarga en  realizar pruebas de funciones de la biblioteca "calculadora"
	 */
